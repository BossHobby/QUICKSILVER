...
typedef enum {
  // Betaflight serialPortFunction_e bits.
  MSP_SERIAL_FUNCTION_NONE = 0,
  MSP_SERIAL_FUNCTION_MSP = (1 << 0),
  MSP_SERIAL_FUNCTION_GPS = (1 << 1),
  MSP_SERIAL_FUNCTION_TELEMETRY_FRSKY_HUB = (1 << 2),
  MSP_SERIAL_FUNCTION_TELEMETRY_HOTT = (1 << 3),
  MSP_SERIAL_FUNCTION_TELEMETRY_LTM = (1 << 4),
  MSP_SERIAL_FUNCTION_TELEMETRY_SMARTPORT = (1 << 5),
  MSP_SERIAL_FUNCTION_RX_SERIAL = (1 << 6),
  MSP_SERIAL_FUNCTION_BLACKBOX = (1 << 7),
  MSP_SERIAL_FUNCTION_TELEMETRY_MAVLINK = (1 << 9),
  MSP_SERIAL_FUNCTION_ESC_SENSOR = (1 << 10),
  MSP_SERIAL_FUNCTION_VTX_SMARTAUDIO = (1 << 11),
  MSP_SERIAL_FUNCTION_TELEMETRY_IBUS = (1 << 12),
  MSP_SERIAL_FUNCTION_VTX_TRAMP = (1 << 13),
  MSP_SERIAL_FUNCTION_RCDEVICE = (1 << 14),
  MSP_SERIAL_FUNCTION_LIDAR_TF = (1 << 15),
  MSP_SERIAL_FUNCTION_FRSKY_OSD = (1 << 16),
  MSP_SERIAL_FUNCTION_VTX_MSP = (1 << 17),
  MSP_SERIAL_FUNCTION_GIMBAL = (1 << 18),
} msp_serial_function_t;

typedef enum {
  // Betaflight baudRate_e indices used by serial config MSP replies.
  MSP_BF_BAUD_AUTO = 0,
  MSP_BF_BAUD_9600,
  MSP_BF_BAUD_19200,
  MSP_BF_BAUD_38400,
