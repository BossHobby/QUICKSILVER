...
__attribute__((weak, alias("Default_Handler_Proxy"))) void FSMC_IRQHandler();
...
__attribute__((weak, alias("Default_Handler_Proxy"))) void CRYP_IRQHandler();
__attribute__((weak, alias("Default_Handler_Proxy"))) void HASH_RNG_IRQHandler();
