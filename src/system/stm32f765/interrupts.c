...
__attribute__((weak, alias("Default_Handler_Proxy"))) void CAN3_TX_IRQHandler();
__attribute__((weak, alias("Default_Handler_Proxy"))) void CAN3_RX0_IRQHandler();
__attribute__((weak, alias("Default_Handler_Proxy"))) void CAN3_RX1_IRQHandler();
__attribute__((weak, alias("Default_Handler_Proxy"))) void CAN3_SCE_IRQHandler();
