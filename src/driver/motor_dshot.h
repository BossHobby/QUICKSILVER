...
extern volatile DMA_RAM uint16_t dma_input_buffer[DSHOT_MAX_PORT_COUNT][GCR_DMA_BUFFER_SIZE];
extern volatile DMA_RAM uint32_t dma_output_buffer[DSHOT_MAX_PORT_COUNT][DSHOT_DMA_BUFFER_SIZE];
