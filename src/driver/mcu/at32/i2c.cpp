...
extern "C" void I2C3_ERR_IRQHandler(void) {
  i2c_err_irq_handler(I2C_PORT3);
}
extern "C" void I2C3_EVT_IRQHandler(void) {
  i2c_irq_handler(I2C_PORT3);
}
extern "C" void I2C4_ERR_IRQHandler(void) {
  i2c_err_irq_handler(I2C_PORT4);
}
extern "C" void I2C4_EVT_IRQHandler(void) {
