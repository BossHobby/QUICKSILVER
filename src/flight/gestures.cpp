...
// Order must match gestures_t enum: GESTURE_NONE, GESTURE_DDD, GESTURE_UUU, GESTURE_RRR, GESTURE_LRL
static const gesture_key_t commands[GESTURE_MAX][GSIZE] = {
    {},                                                                                                                  // GESTURE_NONE
    {GESTURE_CENTER_IDLE, GESTURE_DOWN, GESTURE_CENTER, GESTURE_DOWN, GESTURE_CENTER, GESTURE_DOWN, GESTURE_CENTER},     // GESTURE_DDD - flash gestures
    {GESTURE_CENTER_IDLE, GESTURE_UP, GESTURE_CENTER, GESTURE_UP, GESTURE_CENTER, GESTURE_UP, GESTURE_CENTER},           // GESTURE_UUU
    {GESTURE_CENTER_IDLE, GESTURE_RIGHT, GESTURE_CENTER, GESTURE_RIGHT, GESTURE_CENTER, GESTURE_RIGHT, GESTURE_CENTER},  // GESTURE_RRR - Enter OSD
    {GESTURE_CENTER_IDLE, GESTURE_LEFT, GESTURE_CENTER, GESTURE_RIGHT, GESTURE_CENTER, GESTURE_LEFT, GESTURE_CENTER},    // GESTURE_LRL - Refresh OSD
};

// Order must match osd_input_t enum: OSD_INPUT_NONE, OSD_INPUT_UP, OSD_INPUT_DOWN, OSD_INPUT_LEFT, OSD_INPUT_RIGHT
static const gesture_key_t osd_commands[OSD_INPUT_MAX][OSD_GSIZE] = {
    {},                                                    // OSD_INPUT_NONE
    {GESTURE_CENTER_IDLE, GESTURE_UP, GESTURE_CENTER},     // OSD_INPUT_UP
    {GESTURE_CENTER_IDLE, GESTURE_DOWN, GESTURE_CENTER},   // OSD_INPUT_DOWN
    {GESTURE_CENTER_IDLE, GESTURE_LEFT, GESTURE_CENTER},   // OSD_INPUT_LEFT
    {GESTURE_CENTER_IDLE, GESTURE_RIGHT, GESTURE_CENTER},  // OSD_INPUT_RIGHT
};
...
void gestures() {
  ...
  if (osd_state.screen != OSD_SCREEN_REGULAR) {
    osd_handle_input((osd_input_t)command);
    return;
  }
