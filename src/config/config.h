...
// GPS UART (comment out to leave GPS unassigned by default)
// #define GPS_USART SERIAL_PORT1
// #define GPS_USART SERIAL_PORT2
// #define GPS_USART SERIAL_PORT3
// #define GPS_USART SERIAL_PORT4
// #define GPS_USART SERIAL_PORT5
// #define GPS_USART SERIAL_PORT6
// #define GPS_USART SERIAL_PORT7  // STM32F7/H7/AT32F4 only
// #define GPS_USART SERIAL_PORT8  // STM32F7/H7/AT32F4 only
...
// ---- SWITCH ASSIGNMENTS ----
// Each assignment is {channel, range_min, range_max} where range is 0-65535 (full 16-bit)
// RX_CHANNEL_1..16 maps directly to receiver channels 1..16.
// RX_CHANNEL_OFF = never active, RX_CHANNEL_ON = always active.
#define ARMING {RX_CHANNEL_5, AUX_VALUE_MID, AUX_VALUE_MAX}
#define PREARM {RX_CHANNEL_ON, 0, AUX_VALUE_MAX}
#define IDLE_UP {RX_CHANNEL_5, AUX_VALUE_MID, AUX_VALUE_MAX}
#define LEVELMODE {RX_CHANNEL_OFF, 0, 0}
#define RACEMODE {RX_CHANNEL_OFF, 0, 0}
#define HORIZON {RX_CHANNEL_OFF, 0, 0}
#define STICK_BOOST_PROFILE {RX_CHANNEL_OFF, 0, 0}
#define TURTLE {RX_CHANNEL_OFF, 0, 0}
#define BUZZER_ENABLE {RX_CHANNEL_OFF, 0, 0}
#define MOTORS_TO_THROTTLE_MODE {RX_CHANNEL_OFF, 0, 0}
#define RSSI {RX_CHANNEL_OFF, 0, 0}
#define FPV_SWITCH {RX_CHANNEL_ON, 0, AUX_VALUE_MAX}
#define RATE_ASSIST {RX_CHANNEL_OFF, 0, 0}
#define AUTOTRIM {RX_CHANNEL_OFF, 0, 0}
#define AUTOLAUNCH {RX_CHANNEL_OFF, 0, 0}
