...
// AUX_CHANNEL_0..11 maps to receiver channels 5..16
// AUX_CHANNEL_OFF = never active, AUX_CHANNEL_ON = always active
#define ARMING {AUX_CHANNEL_0, AUX_VALUE_MID, AUX_VALUE_MAX}
#define PREARM {AUX_CHANNEL_ON, 0, AUX_VALUE_MAX}
#define IDLE_UP {AUX_CHANNEL_0, AUX_VALUE_MID, AUX_VALUE_MAX}
#define LEVELMODE {AUX_CHANNEL_OFF, 0, 0}
#define RACEMODE {AUX_CHANNEL_OFF, 0, 0}
#define HORIZON {AUX_CHANNEL_OFF, 0, 0}
#define STICK_BOOST_PROFILE {AUX_CHANNEL_OFF, 0, 0}
#define TURTLE {AUX_CHANNEL_OFF, 0, 0}
#define BUZZER_ENABLE {AUX_CHANNEL_OFF, 0, 0}
#define MOTORS_TO_THROTTLE_MODE {AUX_CHANNEL_OFF, 0, 0}
#define RSSI {AUX_CHANNEL_OFF, 0, 0}
#define FPV_SWITCH {AUX_CHANNEL_ON, 0, AUX_VALUE_MAX}
