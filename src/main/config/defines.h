...
#define PROFILE_FLASH_SIZE 4096
...
static const uint8_t SERIAL_PROTO_MAP[] = {
    ...
    RX_PROTOCOL_SBUS,      //RX_SERIAL_PROTOCOL_SBUS_INVERTED  //No need to filter differently for inverted.
    RX_PROTOCOL_IBUS,      //RX_SERIAL_PROTOCOL_IBUS
    RX_PROTOCOL_FPORT,     //RX_SERIAL_PROTOCOL_FPORT
    RX_PROTOCOL_FPORT,     //RX_SERIAL_PROTOCOL_FPORT_INVERTED  //No need to filter differently for inverted.
