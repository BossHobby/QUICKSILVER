...
constexpr float NOTCH_Q = 3.0f;

// equation is 1 / sqrtf(powf(2, 1.0f / ORDER) - 1);
constexpr float ORDER1_CORRECTION = 1.0f;
constexpr float ORDER2_CORRECTION = 1.55377397403f;
constexpr float ORDER3_CORRECTION = 1.9614591767f;
