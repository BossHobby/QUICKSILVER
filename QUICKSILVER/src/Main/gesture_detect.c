...
#ifdef ENABLE_OSD
// OSD-UP
const uint8_t command12[OSD_GSIZE] = {
	GESTURE_CENTER_IDLE, GESTURE_UP, GESTURE_CENTER
};

// OSD-DOWN
const uint8_t command13[OSD_GSIZE] = {
	GESTURE_CENTER_IDLE, GESTURE_DOWN, GESTURE_CENTER
};

// OSD-RIGHT
const uint8_t command14[OSD_GSIZE] = {
	GESTURE_CENTER_IDLE, GESTURE_RIGHT, GESTURE_CENTER
};

// OSD-LEFT
const uint8_t command15[OSD_GSIZE] = {
	GESTURE_CENTER_IDLE, GESTURE_LEFT, GESTURE_CENTER
};
#endif
