...
void test_ring_buffer_init(void) {
  ...
  TEST_ASSERT_EQUAL_UINT32(TEST_BUFFER_SIZE, ring_buffer_free(&ring_buffer));
}
...
void test_ring_buffer_multiple_write_read(void) {
  ...
  TEST_ASSERT_EQUAL_UINT32(TEST_BUFFER_SIZE - 5, ring_buffer_free(&ring_buffer));
...
void test_ring_buffer_full(void) {
  ...
  TEST_ASSERT_EQUAL_UINT32(1, ring_buffer_free(&ring_buffer));
...
void test_ring_buffer_partial_multi_write(void) {
  ...
  TEST_ASSERT_EQUAL_UINT32(4, ring_buffer_free(&ring_buffer));
