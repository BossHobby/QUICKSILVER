...
extern void test_target_defaults_cbor_decode();
extern void test_target_defaults_apply();
extern void test_target_defaults_storage_capacity();
...
extern void test_blackbox_storage_stall_and_rejected_delta();
extern void test_blackbox_sleeps_until_recording_or_reset();
...
int main(int argc, char **argv) {
  ...
  RUN_TEST(test_target_defaults_cbor_decode);
  RUN_TEST(test_target_defaults_apply);
  RUN_TEST(test_target_defaults_storage_capacity);
  ...
  RUN_TEST(test_blackbox_storage_stall_and_rejected_delta);
  RUN_TEST(test_blackbox_sleeps_until_recording_or_reset);
